...
public class LevelGenerator : MonoBehaviour
{
    ...
    [Tooltip("Do not change chunk length value unless chink prefab size reflects change")]
    ...
    [SerializeField] float unityUnitsToMeters = 0.5f;
    List<GameObject> chunks = new List<GameObject>();
    int chunksSpawned = 0;
    float distanceRan = 0f;
    public float DistanceRan => distanceRan;
    ...
    private void CalculateRanDistance()
    {
        distanceRan += moveSpeed * Time.deltaTime * unityUnitsToMeters;
    }
}
